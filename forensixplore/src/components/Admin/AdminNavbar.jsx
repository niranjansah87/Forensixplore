    ...
    return (
        ...
        <nav className="navh" style={{ backgroundColor: '#14192d' }}>
            <div className="containerdiv nav__container">
                <Link to="/" className="nav__logo"><img className="navv_logo" src={logo} alt="logo" /></Link> {/* Replace anchor tag with Link */}
                ...
                {/* <li><Link to="/admin">Dashboard</Link></li> */}
                <li><Link to="/admin"></Link></li>
                {/* <li><Link to="/admin">View Site</Link></li> */}
                <li><Link to="/admin"></Link></li>
                <li><Link to="/admin"></Link></li>
                ...
                <li><Link to="/admin"></Link></li>
                    ...
                    <li className="nav__profile" onClick={toggleNav}>
                        ...
                        <ul>
                            <li><Link to="/dashboard">Profile</Link></li> {/* Replace anchor tag with Link */}
                            <li><Link to="/logout">Logout</Link></li> {/* Replace anchor tag with Link */}
                        </ul>
                    </li>
                </ul>
